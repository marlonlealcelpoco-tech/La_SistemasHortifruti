    ...
    try {
      ...
      for (const payment of input.payments) {
        ...
        if (payment.paymentMethod === "CREDIT") {
          ...
          await client.query(`INSERT INTO financial_installments (financial_entry_id, installment_number, due_date, amount, settled_amount, status) VALUES ($1, 1, $2, $3, 0, 'PENDING')`, [ar.rows[0].id, payment.dueDate ?? null, payment.amount]);
