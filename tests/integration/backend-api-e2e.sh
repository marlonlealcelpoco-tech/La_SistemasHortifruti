...
# The purchase API returns item IDs used by the confirmation endpoint.
...
# Verify the purchase confirmation changed both cost and stock through the real database.
